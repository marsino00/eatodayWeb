...
class KpaCrudSampleController extends BaseController
{
    ...
    public function demo_simpleTable_full()
    {
         ...
         */
        if ($auth->check()) {
            $codi_establiment = ['codi_establiment' => [3]];
        }
        $crud->setColumnsInfo([
            'id' => ['name' => 'Codi'],
            'email' => [
            ...
            'codi_establiment' => ['name' => 'codi_establiment'],
            'html_atts' => [
                'disabled',
                // 'placeholder="Introdueix l\'adreça mail de l\'usuari"'
            ],
            ...
            // ['codi_establiment' => [
            // 'name' => 'codi_establiment',
            // 'html_atts' => [
            //     'required',
            //     'placeholder="$auth->user()->codi_establiment"'
            // ],
            // ],
            // 'active' => [
    ...
    public function demo_relation1N()
    {
         ...
         */
        $crud->setRelation('codi_establiment', 'establiment', 'codi_establiment', 'nom_establiment');
         ...
         */
        $crud->setColumns(['id', 'username', 'email', 'name', 'surnames', 'codi_establiment']);
