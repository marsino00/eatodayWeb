        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" <?php if (str_contains(base_url(), "establiments")) echo 'active'; ?>" href="#events">Events</a></li>
                    <li><a class="nav-link scrollto" <?php if (str_contains(base_url(), "establiments")) echo 'active'; ?>" href="#chefs">Chefs</a></li>
